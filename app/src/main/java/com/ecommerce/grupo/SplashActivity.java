...
import com.ecommerce.grupo.Adapter.IntroViewPagerAdapter;
import com.ecommerce.grupo.Model.ScreenItem;
...
public class SplashActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mList.add(new ScreenItem("Easy Payments","Most Secure and Easy payments gateway. All UPI's accepted.",R.drawable.img3));
