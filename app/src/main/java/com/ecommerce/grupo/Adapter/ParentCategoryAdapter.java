...
public class ParentCategoryAdapter extends RecyclerView.Adapter<ParentCategoryAdapter.RecyclerViewHolder>{

    private ArrayList<ParentCategoryModel> parentCategoryModels;
    private Context mcontext;

    public ParentCategoryAdapter(ArrayList<ParentCategoryModel> parentCategoryModels, Context mcontext) {
    ...
    @Override
    public void onBindViewHolder(@NonNull ParentCategoryAdapter.RecyclerViewHolder holder, int position) {
        ...
        Glide.with(mcontext).load(modal.getImageUrl())
                .placeholder(R.drawable.placeholder) /// add this
